...
<template>
    ...
    <div class="pseudo-container">
        ...
        <div class="flex justify-start mb-4">
            <div class="w-1/4-">
                <input type="search" placeholder="Search" v-model="search" @keyup="showSpinner()" />
            </div>

            <!-- spinner -->
            <div id="spinner" class="text-center" v-show="spinnerFlag">
                <div role="status">
                    <svg class="inline absolute w-8 h-8 text-gray-50 animate-spin dark:text-gray-500 fill-blue-400"
            ...
            <tbody>
                ...
                <tr v-for="user in users.data" :key="user.id">
                    ...
                    <td v-if="can.delete_user">
                        <button @click="deleteUser(user)" class="bg-red-500 w-6 h-6 rounded-full"></button>
                    </td>
                </tr>
            </tbody>
        </table>
